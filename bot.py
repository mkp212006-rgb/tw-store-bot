...
def menu_itens_kwai(servico_chave: str) -> InlineKeyboardMarkup:
    ...
    keyboard.append([btn("⬅️ Voltar", f"servico_kwai:{servico_chave}")])
    return InlineKeyboardMarkup(keyboard)
...
async def callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Corrige os botões de voltar/navegação do catálogo.
    # Antes, ao voltar a partir de um pacote escolhido, o pedido antigo continuava
    # salvo em context.user_data["pedido"]. Visualmente o menu voltava, mas o bot
    # ainda ficava preso no pedido anterior, parecendo que alguns botões não funcionavam.
    callbacks_navegacao_catalogo = {
        "menu:catalogo",
        "catalogo:redes_sociais",
        "catalogo:instagram",
        "catalogo_instagram:estrangeiros",
        "catalogo_instagram:brasileiros",
        "catalogo:tiktok",
        "catalogo_tiktok:estrangeiros",
        "catalogo:kwai",
        "catalogo_kwai:brasileiros",
        "catalogo:internet",
        "catalogo:iptv",
    }
    prefixos_navegacao_catalogo = (
        "servico:",
        "servico_instagram_br:",
        "servico_tiktok:",
        "servico_kwai:",
    )
    if data in callbacks_navegacao_catalogo or data.startswith(prefixos_navegacao_catalogo):
