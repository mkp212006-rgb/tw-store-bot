...
def texto_mono_telegram(texto: str) -> str:
    # Envia texto em fonte mono no Telegram usando bloco de código Markdown.
    texto = str(texto).replace(chr(96) * 3, "'''")
    return f"```\n{texto}\n```"
...
def texto_pagamento(pedido: dict) -> str:
    ...
    if pedido.get("mp_qr_code"):
        return texto_mono_telegram(resumo_pagamento)
    ...
    return texto_mono_telegram(resumo_pagamento_manual)
