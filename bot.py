...
async def callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "catalogo:internet":
        await safe_edit_or_reply(update, CATALOGO["catalogos"]["internet_ilimitada"]["mensagem"], menu_iptv())
        return

    if data.startswith("item_internet:"):
        _, servico_chave, quantidade_str = data.split(":")
        servico = CATALOGO["catalogos"]["internet_ilimitada"]["servicos"][servico_chave]
        ...
        await safe_edit_or_reply(update, item["mensagem"])
        return
