...
def texto_painel_admin() -> str:
    return (
        ...
        "Gerencie relatórios, cadastros e vendedores em um só lugar."
    )
...
def criar_pagamento_mercado_pago_sync(pedido: dict) -> dict:
    ...
    if pagamento_pendente_expiracao_ativa():
        ...
        payload["date_of_expiration"] = expira_em.isoformat(timespec="seconds")
