...
def texto_escolher_quantidade(catalogo_chave: str, servico_chave: str) -> str:
    ...
    linhas = [
        ...
        "",
        "Só aceito as quantidades abaixo, mantendo exatamente estes valores:",
        "",
    ]
    ...
    linhas.extend([
        "",
        "Exemplo: digite `100`, `500` ou `1000`.",
    ])
...
def mensagem_quantidade_invalida(catalogo_chave: str, servico_chave: str) -> str:
    ...
    return (
        ...
        "Digite somente uma das quantidades disponíveis para esse serviço:\n"
        f"`{md(opcoes)}`\n\n"
        "Os valores continuam exatamente os mesmos do catálogo."
    )
