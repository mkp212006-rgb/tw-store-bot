...
def gerar_imagem_pagamento_instagram(pedido: dict) -> BytesIO | None:
    ...
    escrever_caixa(f"R$ {valor}", (280, 592, 568, 716), 72, 40, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(catalogo, (304, 860, 648, 973), 72, 40, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(servico, (302, 950, 651, 1070), 72, 36, cor=(255, 255, 255), negrito=True, max_linhas=2)
    escrever_caixa(quantidade, (304, 1048, 644, 1164), 72, 40, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(link, (326, 1140, 656, 1256), 72, 36, cor=(255, 255, 255), negrito=True, max_linhas=2)
...
async def enviar_foto_sequencial(update: Update, context: ContextTypes.DEFAULT_TYPE, photo, reply_markup=None):
    await apagar_ultima_mensagem_bot(update, context)
