...
def gerar_imagem_pagamento_instagram(pedido: dict) -> BytesIO | None:
    ...
    escrever_caixa(f"R$ {valor}", (286, 598, 561, 710), 78, 48, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(catalogo, (310, 866, 642, 967), 70, 42, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(servico, (308, 956, 645, 1064), 62, 36, cor=(255, 255, 255), negrito=True, max_linhas=2)
    escrever_caixa(quantidade, (310, 1054, 638, 1158), 74, 44, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(link, (332, 1146, 650, 1250), 60, 34, cor=(255, 255, 255), negrito=True, max_linhas=2)
