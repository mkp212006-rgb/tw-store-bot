...
def gerar_imagem_pagamento_instagram(pedido: dict) -> BytesIO | None:
    ...
    escrever_caixa(f"R$ {valor}", (300, 607, 547, 701), 52, 28, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(catalogo, (320, 875, 632, 958), 44, 26, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(servico, (318, 968, 635, 1052), 40, 22, cor=(255, 255, 255), negrito=True, max_linhas=2)
    escrever_caixa(quantidade, (320, 1063, 628, 1147), 48, 26, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(link, (342, 1156, 640, 1242), 40, 22, cor=(255, 255, 255), negrito=True, max_linhas=2)

    if PIX_CHAVE and PIX_CHAVE != "ttwovendas@gmail.com":
        apagar_area((201, 476, 640, 535), margem=2)
        escrever_caixa(PIX_CHAVE, (201, 466, 640, 545), 42, 22, cor=(255, 255, 255), negrito=True, max_linhas=1)
