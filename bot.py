...
def gerar_imagem_pagamento_instagram(pedido: dict) -> BytesIO | None:
    ...
    escrever_caixa(f"R$ {valor}", (286, 598, 561, 710), 56, 30, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(catalogo, (310, 866, 642, 967), 56, 30, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(servico, (308, 956, 645, 1064), 56, 30, cor=(255, 255, 255), negrito=True, max_linhas=2)
    escrever_caixa(quantidade, (310, 1054, 638, 1158), 56, 30, cor=(255, 255, 255), negrito=True, max_linhas=1)
    escrever_caixa(link, (332, 1146, 650, 1250), 56, 30, cor=(255, 255, 255), negrito=True, max_linhas=2)
...
async def enviar_pagamento_cliente(update: Update, context: ContextTypes.DEFAULT_TYPE, pedido: dict):
    """Envia pagamento como imagem para Instagram/TikTok e como texto para as demais categorias."""
    imagem = None
