...
Observação: `ADMIN2_CHAT_ID` também recebe o relatório semanal automático. Os relatórios individuais de venda/pagamento continuam sendo enviados apenas ao `ADMIN_CHAT_ID`.
