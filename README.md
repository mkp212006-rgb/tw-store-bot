...
Também foi adicionado controle para não processar o mesmo pagamento duas vezes caso o webhook e o botão **Já paguei / verificar** sejam acionados quase ao mesmo tempo.
